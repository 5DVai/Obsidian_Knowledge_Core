# Decepticon Supervisor Prompt Framework
**Source:** Decepticon\src\prompts\base\supervisor.py  
**Ingestion Date:** 2025-11-28

## Executive Summary
The file defines the foundational prompt for the Supervisor role within the Decepticon framework, a premier autonomous red team testing service. This prompt outlines the responsibilities, strategic principles, and operational standards expected of the Lead Supervisor Agent. It serves as a blueprint for conducting world-class cybersecurity assessments, emphasizing strategic decision-making, operational precision, and client value delivery. The document is crucial for maintaining the high standards of Decepticon's cybersecurity operations and ensuring that every engagement is executed with excellence.

The prompt is structured to guide the Supervisor in making informed, strategic decisions that maximize operational efficiency and effectiveness. It emphasizes the importance of language adaptability, strategic planning, comprehensive coverage, and maintaining a high operational tempo. The document also outlines the available agents and their roles, providing a clear framework for decision-making and mission execution.

## Key Concepts & Principles
- **Language Adaptability:** Respond in the user's language while maintaining clarity in technical terms.
- **Strategic Mastery:** Utilize decades of red team expertise to guide decisions.
- **Operational Precision:** Ensure zero tolerance for inefficiency.
- **Mission Accountability:** Complete ownership of engagement success.
- **Excellence Metrics:** Strategic precision, comprehensive coverage, operational tempo, and value delivery.
- **Decision Framework:** Planning first, systematic progression, strategic pivots, documentation excellence, and mission completion.

## Detailed Technical Analysis

### Language Instructions
The prompt begins with a directive to detect and respond in the user's language, ensuring that communication is clear and effective. This adaptability is crucial for maintaining engagement and understanding across diverse linguistic contexts.

### Role Definition
The Supervisor is positioned as the pinnacle of cybersecurity expertise, responsible for orchestrating sophisticated penetration testing operations. This role requires a deep understanding of strategic planning and operational execution.

### Performance Standards
The document outlines specific metrics for excellence, including strategic precision and comprehensive coverage. These standards ensure that every operation is conducted with the highest level of professionalism and effectiveness.

### Decision Framework
The framework provides a structured approach to decision-making, emphasizing the importance of planning, systematic progression, and strategic pivots. This ensures that operations are conducted logically and efficiently.

### Available Agents
The prompt lists the available agents and their roles, providing a clear understanding of the resources at the Supervisor's disposal. This includes strategic planning, intelligence gathering, vulnerability exploitation, and documentation.

## Enterprise Q&A Bank

1. **Q:** What is the primary role of the Supervisor in Decepticon?
   **A:** The Supervisor orchestrates world-class red team operations, ensuring comprehensive security assessments and maintaining operational excellence.

2. **Q:** How should the Supervisor handle language differences in communication?
   **A:** The Supervisor should detect and respond in the user's language, keeping technical terms in English for clarity.

3. **Q:** What are the key performance standards for the Supervisor?
   **A:** Strategic precision, comprehensive coverage, operational tempo, and value delivery.

4. **Q:** What is the importance of the decision framework?
   **A:** It provides a structured approach to decision-making, ensuring logical and efficient operations.

5. **Q:** How does the Supervisor ensure mission accountability?
   **A:** By owning the complete success of every engagement and ensuring each agent operates at peak effectiveness.

## Actionable Takeaways
- Ensure communication is in the user's preferred language while maintaining clarity in technical terms.
- Adhere to strategic planning and operational precision to maintain high standards.
- Utilize the decision framework to guide logical and efficient operations.
- Maintain accountability for the success of every engagement.
- Leverage available agents effectively to achieve mission objectives.
